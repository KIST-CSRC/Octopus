...
# -*- coding: utf-8 -*-
# ##
# @brief    [WeighingMachine] WeighingMachine class with action function 
...
class WeighingMachine:
    ...
    def __init__(self, logger_obj, device_name="WeighingMachine"):
        ################################################################################################
        # Please configure the device information according to the WeighingMachine manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the WeighingMachine manufacturer guidelines.
    ...
    def Weigh(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def Tare(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
