...
from Stirrer.Stirrer import Stirrer
from PowderDispenser.PowderDispenser import PowderDispenser
from WeighingMachine.WeighingMachine import WeighingMachine
...
if __name__ == "__main__":
    # TCP/IP
    MODULE_HOST='192.167.1.13'  # set IP address of module node computer
    MODULE_PORT=54009 # if you want, can change. but match port number with master node and device server
    module_name='SolidStateModule' # set module name
    ...
    Stirrer_obj = Stirrer(NodeLogger_obj) # please check your device class
    PowderDispenser_obj = PowderDispenser(NodeLogger_obj) # please check your device class
    WeighingMachine_obj = WeighingMachine(NodeLogger_obj) # please check your device class
    Heater_obj = Heater(NodeLogger_obj) # please check your device class
    # Device server
    RobotArm_obj = TCP_Class('RobotArm', '192.167.1.13', 54010, NodeLogger_obj) # please check your device class
    Pipette_obj = TCP_Class('Pipette', '192.167.1.13', 54010, NodeLogger_obj) # please check your device class
    Pump_obj = TCP_Class('Pump', '192.167.1.13', 54011, NodeLogger_obj) # please check your device class
    device_obj_dict={
        "Stirrer":Stirrer_obj,
        "PowderDispenser":PowderDispenser_obj,
        "WeighingMachine":WeighingMachine_obj,
        "Heater":Heater_obj,
