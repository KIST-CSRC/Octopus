...
# -*- coding: utf-8 -*-
# ##
# @brief    [Heater] Heater class with action function 
...
class Heater:
    ...
    def __init__(self, logger_obj, device_name="Heater"):
        ################################################################################################
        # Please configure the device information according to the Heater manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Heater manufacturer guidelines.
