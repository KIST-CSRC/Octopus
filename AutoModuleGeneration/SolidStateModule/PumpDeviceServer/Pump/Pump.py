...
# -*- coding: utf-8 -*-
# ##
# @brief    [Pump] Pump class with action function 
...
class Pump:
    ...
    def __init__(self, logger_obj, device_name="Pump"):
        ################################################################################################
        # Please configure the device information according to the Pump manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Pump manufacturer guidelines.
    ...
    def Start(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def Increase(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Decrease(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Reverse(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
