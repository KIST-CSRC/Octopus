...
SIZE = 104857600
device_server_name='PumpDeviceServer'
...
server_socket.bind(('192.167.1.13', 54011))  # Specifying IP address and port number
server_socket.listen()  # Waiting for a module node's connection request

Pump_obj = Pump(NodeLogger_obj) # please check your device class
device_obj_dict={
    "Pump":Pump_obj,
}
