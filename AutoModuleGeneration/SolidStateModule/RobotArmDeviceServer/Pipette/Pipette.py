...
# -*- coding: utf-8 -*-
# ##
# @brief    [Pipette] Pipette class with action function 
...
class Pipette:
    ...
    def __init__(self, logger_obj, device_name="Pipette"):
        ################################################################################################
        # Please configure the device information according to the Pipette manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Pipette manufacturer guidelines.
    ...
    def Aspirate(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def Rinse(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Mix(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Eject(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Calibrate(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
