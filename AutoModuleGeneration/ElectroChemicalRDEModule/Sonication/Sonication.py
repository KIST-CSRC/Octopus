...
class Sonication:
    ...
    def __init__(self, logger_obj, device_name="Sonication"):
        ################################################################################################
        # Please configure the device information according to the Sonication manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Sonication manufacturer guidelines.
    ...
    def Sonicate(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def Pulse(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
