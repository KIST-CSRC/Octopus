...
class Cell:
    ...
    def __init__(self, logger_obj, device_name="Cell"):
        ################################################################################################
        # Please configure the device information according to the Cell manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Cell manufacturer guidelines.
    ...
    def Culture(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def Incubate(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Harvest(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
