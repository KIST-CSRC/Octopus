...
class GasRegulator:
    ...
    def __init__(self, logger_obj, device_name="GasRegulator"):
        ################################################################################################
        # Please configure the device information according to the GasRegulator manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the GasRegulator manufacturer guidelines.
    ...
    def RegulateFlow(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def StopFlow(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
    ...
    def Purge(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
