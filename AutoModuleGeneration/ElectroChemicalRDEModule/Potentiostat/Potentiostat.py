...
class Potentiostat:
    ...
    def __init__(self, logger_obj, device_name="Potentiostat"):
        ################################################################################################
        # Please configure the device information according to the Potentiostat manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the Potentiostat manufacturer guidelines.
    ...
    def SetPotential(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def RunTest(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
