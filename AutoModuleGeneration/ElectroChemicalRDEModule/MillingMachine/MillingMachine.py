...
class MillingMachine:
    ...
    def __init__(self, logger_obj, device_name="MillingMachine"):
        ################################################################################################
        # Please configure the device information according to the MillingMachine manufacturer guidelines.
        ...
        ################################################################################################
        # Please configure the types of actions according to the MillingMachine manufacturer guidelines.
    ...
    def Mill(self, action_data:str, mode_type:str="virtual") -> str:
        '''
    ...
    def ChangeTool(self, action_data:str, mode_type:str="virtual") -> str:
        '''
        :param action_data (str) :
        :param mode_type="virtual" (str): set virtual or real mode
