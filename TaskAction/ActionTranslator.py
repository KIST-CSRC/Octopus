...
class RobotMovModule(ActionExecutor):
    """
...
class ActionTranslator(RobotMovModule, BatchSynthesisModule, UVModule):
    """
    ActionTranslator class read recipe file (json), and allocate & link each task to proper devices
